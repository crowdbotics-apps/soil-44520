"""
Django settings for soil_44520 project.
...
WSGI_APPLICATION = 'soil_44520.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "soil_44520 API",
    "DESCRIPTION": "API documentation for soil_44520 App",
    "VERSION": "v1",
}
